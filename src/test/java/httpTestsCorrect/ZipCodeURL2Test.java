...
public class ZipCodeURL2Test {
    ...
    public void getZipCodesTest() {
        final ResponseEntity<List<String>> zipCodes = zipCodeClient.getZipCodesURl2();
    ...
    public void postZipCodesTest() {
        final ResponseEntity<List<String>> zipCodes = zipCodeClient.postZipCodesURL2(List.of(zipCodeRand1, zipCodeRand2));
    ...
    public void postZipCodesInSentListDuplicatesTest() {
           ResponseEntity<List<String>> zipCodes = zipCodeClient.postZipCodesURL2(List.of(zipCodeRand1, zipCodeRand1));
           Assert.assertEquals(zipCodes.getStatusCode(),Const.STATUS_201,"Isn't 201");
    ...
    public void postZipCodesOnServerDuplicatesTest() {
        ...
        ResponseEntity<List<String>> zipCodes = zipCodeClient.postZipCodesURL2(zipCodesOnServer);
